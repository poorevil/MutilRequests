...
#        albumId = picResultDict['info']['albumId']
    ...
    def getPicWaterFlow(self):
        ...
        [
            {
                "info": {
                    "albumId": 22406495,
                    "albumLink": "/album/22406495?u=73236508",
                    "userId": 73236508,
                    "albumName": "春日萌妞美裙卖萌搭",
                    "nick": "芭米尔公主",
                    "avatar": "i2/T1q5C8XklkXXb1upjX.jpg",
                    "time": "2013-03-15 15:00:12",
                    "type": 2,
                    "userLink": "/73236508"
                },
                "favStatus": false,
                ...
                "height": 220,
                "width": 220,
                "picPath": "http://img02.taobaocdn.com/imgextra/i2/16508020437942421/T1f9JJXBldXXXXXXXX_!!73236508-0-pix.jpg",
                "link": "/detail/63972418?wantu_c=qinzi&u=73236508",
                "picType": 1,
                "id": 63972418,
                "desc": "春装款女童气质长袖连衣裙，纯棉面料荷叶边裙摆设计，穿着舒适，非常漂亮哦。"
            },
            ...
        ]
        '''
        try:
            ...
            page = etree.HTML(self.response.text, parser=None, base_url=None);
...
#                picModelList = []       #结果
                ...
                for dicttmp in jsonDict['data']['waterfall']:
                    ...
                    try:
                        ...
                        setTaokeDetail 后的结果
                        {
                            "info": {
                                "albumId": 22406808,
                                "albumLink": "/album/22406808?u=11807721",
                                "userId": 11807721,
                                "albumName": "人见人爱！甜美公主鞋",
                                "nick": "cindy_zyx",
                                "avatar": "i1/T1Jva9XaBeXXb1upjX.jpg",
                                "time": "2013-03-15 16:31:30",
                                "type": 2,
                                "userLink": "/11807721"
                            },
                            "favStatus": false,
                            ...
                            "collect": 0,
                            "price": "65.00",
                            "title": "2013春季新款女童单鞋 韩版花边纯色公主鞋 亮面单皮鞋儿童小童鞋",
                            "num_iid": "17334258007",
                            "comments": 0,
                            "height": 223,
                            "width": 220,
                            "picPath": "http://img02.taobaocdn.com/imgextra/i2/17721022367991794/T1U14JXrtfXXXXXXXX_!!11807721-0-pix.jpg",
                            "sellNum": 0,
                            "link": "/detail/63997891?wantu_c=qinzi&u=11807721",
                            "picType": 1,
                            "id": 63997891,
                            "desc": "韩版花边纯色公主鞋 ，花朵装饰，十足的公主范儿。"
                        },
                        '''
    
                        picModel = PicModel.PicModel(dicttmp['id']
                                            ,dicttmp['picPath']
                                            ,dicttmp['height']
                                            ,dicttmp['width']
                                            ,dicttmp['desc']
                                            ,self.cid
                                            ,self.rootCid
                                            ,dicttmp['info']['albumName']
                                            ,dicttmp['info']['albumId']
                                            ,dicttmp['info']['userId']
                                            ,dicttmp['info']['time']
                                            ,dicttmp['num_iid']
                                            ,dicttmp['price']
...
#                    picModelList.append(picModel)
                
#                ''' 文件名 result_cid_xrootcid_x_x '''
#                fileName = 'result_cid_%d_rootcid_%d'%(self.cid,self.rootCid)
#                
#                if self.url.find('p=') > 0:
#                    fileName = fileName+'_'+self.url[self.url.find('p=')+2:]
#                else:
#                    fileName = fileName+'_1'
#                
#                with open(fileName,'w') as fp:
#                    fp.write(self.unescape(str(json.dumps(picModelList, default=PicModel.PicModel.serialize))))
...
def loadPicDetailByFirestPageUrlAndNextPageNum(url,socketTimeout,redirects,categoaryId,rootCategoaryId,nextAmount=0):
    '''
    url                :必须是第一页
...
#                 %(url,nextAmount,socketTimeout,redirects,categoaryId,rootCategoaryId))
...
if __name__ == '__main__':
    '''亲子'''
    r = loadPicDetailByFirestPageUrlAndNextPageNum('http://guang.taobao.com/square/index.htm?spm=a310p.2219213.5890545.2.j8we5Z&cat_id=9&tag_id=0&type=1&sort=0'#'http://wantu.taobao.com/qinzi/new?spm=a1z0j.1000827.0.122.yqX4aX&type=shopping'
                                                  ,15,False,categoaryId = 9,rootCategoaryId = 0,nextAmount=2)
    
#    '''服饰'''
#    r = loadPicDetailByFirestPageUrlAndNextPageNum('http://wantu.taobao.com/fushi/new'
#                                                  ,15,False,categoaryId = 1,rootCategoaryId = 0,nextAmount=15)
